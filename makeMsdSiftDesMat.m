...
% Oxford-102 flower dataset. It accumulates the MSD-SIFT 
...
% multiple kernel learning (Oxford-102 dataset) is listed as 
...
save([outPath,'TrainDesc_',featName,'.mat'],'trainDesc','-v7.3');
